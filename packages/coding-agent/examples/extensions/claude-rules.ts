 ...
 * in the system prompt. The agent can then use code to load
...
When working on tasks related to these rules, use code to load the relevant rule files for guidance.
`,
		};
	});
}
