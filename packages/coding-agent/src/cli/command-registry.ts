...
export const COMMAND_SPECS: readonly CommandSpec[] = [
	...
	},
	{
		...
		summary: "Install pi on a host and add to fleet",
	},
];
...
const TOP_LEVEL_OPTION_GROUPS: ReadonlyArray<{ heading: string; options: readonly TopLevelOption[] }> = [
	{
		...
		options: [
			...
			["--mode <text|json>", "Select the output mode (default: text)"],
...
export function formatTopLevelHelp(): string {
	...
	return `${APP_NAME} - AI coding assistant with a JS code tool
