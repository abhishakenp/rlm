...
export type AgentExecutionMode = "interactive" | "print" | "json";
...
export interface AgentSessionRuntimeConfig {
	 ...
	 * agent_end. Used by the JSON/print client so refine survives the
...
/** Only non-secret host settings needed to locate and govern durable session state. */
